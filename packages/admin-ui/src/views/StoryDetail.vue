        ...
        <article class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
          ...
          <div class="p-6 sm:p-8">
            ...
            <div class="mb-6">
              ...
              <div v-else class="relative rounded-lg overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 h-16 flex items-center justify-center">
                <div class="text-center text-gray-500">
                  <svg class="w-6 h-6 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 011 1.732l4 4A2 2 0 0120 11v7a2 2 0 01-2 2z"></path>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 3.5v5a2 2 0 002 2h5"></path>
                  </svg>
                  <p class="text-xs">News Story</p>
                </div>
              </div>
            </div>
