    ...
    <div v-else class="stories-container">
      ...
      >
        <div class="story-card-content">
          <!-- Story Image -->
          <div class="story-image-container" v-if="getStoryImage(story)">
            <img 
...
const getStoryImage = (story: Story) => {
  // Use the imageUrl provided by the API (first valid image from story articles)
  if (story.imageUrl && story.imageUrl.trim() && story.imageUrl !== 'null') {
    try {
...
const handleImageError = (event: Event) => {
  ...
  const container = img.closest('.story-image-container') as HTMLElement
  if (container) {
